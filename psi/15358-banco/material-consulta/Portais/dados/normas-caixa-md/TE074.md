...
**Creationdate**: D:20250612123015-03'00'

**Moddate**: D:20250612133053-03'00'
...
- **ANEXO I â Guia RÃ¡pido - Modelagem de dados relacional para sistemas e aplicativos de negÃ³cio CAIXA.pdf** - 52,741 bytes
  - Extraído para: `C:\Desenvolvimento\Analise\Normas-Caixa\pdf\anexos_extraidos\ANEXO I â Guia RÃ¡pido - Modelagem de dados relacional para sistemas e aplicativos de negÃ³cio CAIXA.pdf`
...
METAMODELAGEM,10 
3.2.16 
FRAMEWORKS ESPECÍFICOS APROVADOS PELA SUART,10 
3.2.17 
...
3.5 
INTEGRAÇÃO E COMPARTILHAMENTO DE DADOS,12 
3.6 
...
Itens 3.2.12.1, 3.2.12.5.1 e 3.2.12.7: alteração de texto para melhor entendimento. 
...
2  
DEFINIÇÕES 
2.1 Disponível em http://dados.caixa/portal/glossario?norma=TE074. 
3  
REGRAS 
3.1  
 FUNDAMENTO 
...
Validação de Modelos de Dados Caixa, disponível no site https://caixa.sharepoint.com/sites/5141/SitePages/Guia-
para-Modelagem-e-Valida%C3%A7%C3%A3o-de-Modelos-de-Dados.aspx. 
...
detalhada no site https://caixa.sharepoint.com/sites/5141/SitePages/Estimativa-Prazo-Atendimento-UAM.aspx. 
...
3.2.1.2 A padronização de nomenclatura dos objetos físicos está detalhada nos guias Nomenclatura de Objetos e 
...
modelagem de dados está detalhada no site https://caixa.sharepoint.com/sites/5141/SitePages/Guia-de-Modelagem-
Spring-Batch.aspx. 
...
## 🔗 Links Encontrados
- [http://dados.caixa/portal/glossario?norma=TE074](http://dados.caixa/portal/glossario?norma=TE074)
- [http://normas.caixa/normativo/TE174](http://normas.caixa/normativo/TE174)
- [http://normas.caixa/normativo/OR188](http://normas.caixa/normativo/OR188)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Guia-para-Modelagem-e-Valida%C3%A7%C3%A3o-de-Modelos-de-Dados.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Guia-para-Modelagem-e-Valida%C3%A7%C3%A3o-de-Modelos-de-Dados.aspx)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Guia-para-Modelagem-e-Valida%C3%A7%C3%A3o-de-Modelos-de-Dados.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Guia-para-Modelagem-e-Valida%C3%A7%C3%A3o-de-Modelos-de-Dados.aspx)
- [http://normas.caixa/normativo/TE111](http://normas.caixa/normativo/TE111)
- [http://normas.caixa/normativo/PO007](http://normas.caixa/normativo/PO007)
- [http://normas.caixa/normativo/TE197](http://normas.caixa/normativo/TE197)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Estimativa-Prazo-Atendimento-UAM.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Estimativa-Prazo-Atendimento-UAM.aspx)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Nomenclatura-de-Objetos.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Nomenclatura-de-Objetos.aspx)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Express%C3%B5es-Regulares-que-Definem-Objetos-F%C3%ADsicos-dos-SGBD.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Express%C3%B5es-Regulares-que-Definem-Objetos-F%C3%ADsicos-dos-SGBD.aspx)
- [http://ppds.caixa/](http://ppds.caixa/)
- [http://ppds.caixa/](http://ppds.caixa/)
- [http://normas.caixa/normativo/OR016](http://normas.caixa/normativo/OR016)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Guia-de-Modelagem-Spring-Batch.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Guia-de-Modelagem-Spring-Batch.aspx)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Guia-de-Modelagem-Spring-Batch.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Guia-de-Modelagem-Spring-Batch.aspx)
...
## 🔗 Links Encontrados
- [http://normas.caixa/normativo/TE073](http://normas.caixa/normativo/TE073)
...
3.2.3.6.1 No caso de inclusão/manutenção de View, a nomeação e descrição, inclusive de colunas, serão validados 
pela ADI para posterior encaminhamento para avaliação do ABD. 
...
3.2.3.9.2 Os modelos de dados relacionais contem apenas uma técnica de modelagem de dados. 
3.2.4  
TABELA 
...
Modelos de Dados Caixa disponível no site https://caixa.sharepoint.com/sites/5141/SitePages/Guia-para-Modelagem-
e-Valida%C3%A7%C3%A3o-de-Modelos-de-Dados.aspx. 
...
3.2.8.5 Informações adicionais sobre os critérios que são utilizados para particionamento estão disponíveis no 
ppds.caixa, https://caixa.sharepoint.com/sites/PPDS/SitePages/Particionamento.aspx. 
...
- [http://ppds.caixa/](http://ppds.caixa/)
- [http://ppds.caixa/](http://ppds.caixa/)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Particionamento.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Particionamento.aspx)
...
no ppds.caixa, https://caixa.sharepoint.com/sites/PPDS/SitePages/Compacta%C3%A7%C3%A3o.aspx 
3.2.10  
...
no ppds.caixa, https://caixa.sharepoint.com/sites/PPDS/SitePages/Ciclo-de-Vida-dos-Dados.aspx 
3.2.11  
RELACIONAMENTO 
...
- [http://ppds.caixa/](http://ppds.caixa/)
- [http://ppds.caixa/](http://ppds.caixa/)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Compacta%C3%A7%C3%A3o.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Compacta%C3%A7%C3%A3o.aspx)
- [http://ppds.caixa/](http://ppds.caixa/)
- [http://ppds.caixa/](http://ppds.caixa/)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Ciclo-de-Vida-dos-Dados.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Ciclo-de-Vida-dos-Dados.aspx)
...
no guia de Nomenclatura de Objetos, disponível no ppds.caixa. 
...
3.2.12.5.1 Mais detalhes podem ser obtidos no site https://caixa.sharepoint.com/sites/5141/SitePages/Guia-para-
...
ppds.caixa, disponível em https://caixa.sharepoint.com/sites/5141/SitePages/Datatypes-SGBD.aspx. 
...
- [http://ppds.caixa/](http://ppds.caixa/)
- [http://ppds.caixa/](http://ppds.caixa/)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Datatypes-SGBD.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Datatypes-SGBD.aspx)
...
prerrogativas de modelagem, consultar o ppds.caixa, disponível em Regras de modelagem para Frameworks 
Autorizados (sharepoint.com). 
3.2.17  
...
3.2.17.3 A definição de privacidade de dados na modelagem está descrita no ppds.caixa, disponível em Guia Privacy 
by Design da Arquitetura de TI (sharepoint.com). 
...
Dados, descrita no ppds.caixa, disponível em Guia de Padrões e Convenções de Diagrama de Modelos de Dados 
(sharepoint.com).  
3.3  
...
Informações. 
3.3.3 O primeiro passo na validação de um modelo de dados é a utilização da ferramenta de pré-validação 
...
## 🔗 Links Encontrados
- [http://ppds.caixa/](http://ppds.caixa/)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Regras-de-modelagem-para-Frameworks-Autorizados.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Regras-de-modelagem-para-Frameworks-Autorizados.aspx)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Regras-de-modelagem-para-Frameworks-Autorizados.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Regras-de-modelagem-para-Frameworks-Autorizados.aspx)
- [http://ppds.caixa/](http://ppds.caixa/)
- [http://ppds.caixa/](http://ppds.caixa/)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Guia-Privacy-by-Design-da-Arquitetura-de-TI.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Guia-Privacy-by-Design-da-Arquitetura-de-TI.aspx)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Guia-Privacy-by-Design-da-Arquitetura-de-TI.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Guia-Privacy-by-Design-da-Arquitetura-de-TI.aspx)
- [http://normas.caixa/normativo/CR439](http://normas.caixa/normativo/CR439)
- [http://ppds.caixa/](http://ppds.caixa/)
- [http://ppds.caixa/](http://ppds.caixa/)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Guia_Qualificacao_Grafica.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Guia_Qualificacao_Grafica.aspx)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Guia_Qualificacao_Grafica.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Guia_Qualificacao_Grafica.aspx)
- [http://gestaodedados.coresp.caixa/](http://gestaodedados.coresp.caixa/)
- [http://gestaodedados.coresp.caixa/](http://gestaodedados.coresp.caixa/)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Valida%C3%A7%C3%B5es-executadas-no-Pr%C3%A9-Validador.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Valida%C3%A7%C3%B5es-executadas-no-Pr%C3%A9-Validador.aspx)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Valida%C3%A7%C3%B5es-executadas-no-Pr%C3%A9-Validador.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Valida%C3%A7%C3%B5es-executadas-no-Pr%C3%A9-Validador.aspx)
...
sistemas. 
3.3.8 Os objetos do modelo físico são padronizados com base nas instruções contidas no guia Expressões Regulares 
que Definem Objetos Físicos dos SGBD, conforme o SGBD de implementação, e são utilizadas as melhores práticas 
para o armazenamento e desempenho apropriado de cada objeto nesse SGBD. 
3.3.9 Os Tipos de Dados permitidos por cada Sistema Gerenciador de Banco de Dados estão descritos no ppds.caixa, 
disponível em https://caixa.sharepoint.com/sites/5141/SitePages/Datatypes-SGBD.aspx. 
3.3.9.1 Os Tipos de Dados que não constam da lista serão analisados e resolvidos com a decisão da SUART. 
3.3.10 A Lista de Inconsistência de objetos do modelo de dados consta na Lista de Objetos para Validação do Modelo 
de Dados. 
...
▪ Não Aprovado. 
3.3.11.1 Quando da não aprovação do Laudo de Validação não é preenchido o item Conclusão da demanda para a 
...
- [http://ppds.caixa/](http://ppds.caixa/)
- [https://caixa.sharepoint.com/sites/5141/SitePages/Datatypes-SGBD.aspx](https://caixa.sharepoint.com/sites/5141/SitePages/Datatypes-SGBD.aspx)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Lista-de-Objetos-para-Valida%C3%A7%C3%A3o-do-Modelo-de-Dados.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Lista-de-Objetos-para-Valida%C3%A7%C3%A3o-do-Modelo-de-Dados.aspx)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Lista-de-Objetos-para-Valida%C3%A7%C3%A3o-do-Modelo-de-Dados.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Lista-de-Objetos-para-Valida%C3%A7%C3%A3o-do-Modelo-de-Dados.aspx)
- [http://normas.caixa/normativo/TE105](http://normas.caixa/normativo/TE105)
- [http://normas.caixa/normativo/TE124](http://normas.caixa/normativo/TE124)
- [http://normas.caixa/normativo/TE109](http://normas.caixa/normativo/TE109)
...
de Dados envolvendo a aplicação da norma, sendo demandada por meio do RTC (http://ti.caixa). 
4.2  
...
## 🔗 Links Encontrados
- [https://portalapi.caixa/redoc.html](https://portalapi.caixa/redoc.html)
- [http://normas.caixa/normativo/TE109](http://normas.caixa/normativo/TE109)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Lista-de-Objetos-para-Valida%C3%A7%C3%A3o-do-Modelo-de-Dados.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Lista-de-Objetos-para-Valida%C3%A7%C3%A3o-do-Modelo-de-Dados.aspx)
- [https://caixa.sharepoint.com/sites/PPDS/SitePages/Lista-de-Objetos-para-Valida%C3%A7%C3%A3o-do-Modelo-de-Dados.aspx](https://caixa.sharepoint.com/sites/PPDS/SitePages/Lista-de-Objetos-para-Valida%C3%A7%C3%A3o-do-Modelo-de-Dados.aspx)
- [http://normas.caixa/normativo/TE190](http://normas.caixa/normativo/TE190)
- [http://normas.caixa/normativo/AD238](http://normas.caixa/normativo/AD238)
- [http://normas.caixa/normativo/TE183](http://normas.caixa/normativo/TE183)
...
4.2.4.1 Utilizar o pré-validador (http://gestaodedados.coresp.caixa) para avaliar as evoluções dos modelos de dados 
de forma a adequá-los às regras básicas de modelagem regidas por esta norma. 
...
## 🔗 Links Encontrados
- [https://gid.caixa:9443/ccm/web/projects/Acionamento%20Cap%C3%ADtulos#action=com.ibm.team.workitem.newWorkItem&type=solicitacao_suporte](https://gid.caixa:9443/ccm/web/projects/Acionamento%20Cap%C3%ADtulos#action=com.ibm.team.workitem.newWorkItem&type=solicitacao_suporte)
- [http://normas.caixa/normativo/TE177](http://normas.caixa/normativo/TE177)
- [http://gestaodedados.coresp.caixa/](http://gestaodedados.coresp.caixa/)
- [http://gestaodedados.coresp.caixa/](http://gestaodedados.coresp.caixa/)
- [https://gid.caixa:9443/ccm/web/projects/Acionamento%20Cap%C3%ADtulos#action=com.ibm.team.workitem.newWorkItem&type=solicitacao_suporte](https://gid.caixa:9443/ccm/web/projects/Acionamento%20Cap%C3%ADtulos#action=com.ibm.team.workitem.newWorkItem&type=solicitacao_suporte)
...
desenvolvimento bem como ao ABD de Produção. Somente a equipe de ABD de Desenvolvimento possui permissão 
de gravação. 
